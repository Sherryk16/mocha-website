...
import { IconArrowRight, IconCheck, IconCoffee, IconLeaf, IconShield, IconTruck } from "@/components/ui/icons";
  ...
  return (
    <>
      <section className="relative">
        <div className="relative h-[320px] overflow-hidden bg-coffee-900 sm:h-[420px]">
          <Image
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-coffee-900/85 via-coffee-900/55 to-coffee-900/20" />
          <Container className="relative z-10 flex h-full items-center">
            <div className="max-w-2xl">
              <Eyebrow className="text-accent">About us</Eyebrow>
              <h1 className="mt-3 font-display text-4xl font-bold leading-tight text-coffee-50 sm:text-5xl text-balance">
                Built for cafés that don't have time for surprises.
              </h1>
              <p className="mt-4 text-base text-coffee-100 sm:text-lg">
      ...
      <Container className="py-16 sm:py-20">
        <div className="grid items-start gap-12 lg:grid-cols-2">
          <div>
            ...
            <Heading className="mt-2">From a single roaster to a wholesale desk.</Heading>
          ...
          <div>
            <div className="rounded-3xl border border-coffee-200 bg-white p-7">
              <Eyebrow>Mission</Eyebrow>
              <p className="mt-2 font-display text-lg leading-relaxed text-coffee-900">
              ...
              <hr className="my-5 border-coffee-200" />
        ...
        <Container className="py-16 sm:py-20">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {VALUES.map((v) => (
              <div
                key={v.title}
                className="rounded-2xl border border-coffee-200 bg-white p-6 smooth-shadow"
              >
                <v.icon className="h-6 w-6 text-coffee-700" />
                <h3 className="mt-3 font-display text-lg font-semibold text-coffee-900">
                  {v.title}
                </h3>
                <p className="mt-2 text-sm text-coffee-700">{v.body}</p>
              </div>
            ))}
          </div>
        </Container>
      ...
      <Container className="py-16 sm:py-20">
        <div className="mx-auto max-w-2xl rounded-3xl border border-coffee-200 bg-white p-8 text-center smooth-shadow">
          <span className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-coffee-800 text-accent">
            <IconCheck className="h-6 w-6" />
          </span>
          <h2 className="mt-4 font-display text-2xl font-bold text-coffee-900">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <Link
              href="/wholesale"
              className="inline-flex h-11 items-center gap-2 rounded-full bg-coffee-800 px-6 text-sm font-semibold text-coffee-50 hover:bg-coffee-900"
            >
              Apply for wholesale
            ...
            <Link
              href="/contact"
              className="inline-flex h-11 items-center rounded-full border border-coffee-300 px-6 text-sm font-semibold text-coffee-800 hover:bg-coffee-100"
            >
              Talk to a person
            </Link>
          </div>
